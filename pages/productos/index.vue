  ...
  <div>
    ...
    <div class="grid mt-10 md:grid-cols-3 lg:grid-cols-10">
      <div class="flex justify-center px-8 py-10 lg:col-span-3 2xl:col-span-2">
        <FiltroProducto
          @getGruposSeleccionados="getGruposSeleccionados"
        ></FiltroProducto>
      </div>

      <div
        class="grid justify-center min-h-screen grid-cols-1 py-10 sm:grid-cols-2 md:col-span-3 lg:col-span-7 2xl:col-span-8 lg:grid-cols-3 2xl:grid-cols-5 lg:mt-4 xl:mr-4"
      >
        <div
